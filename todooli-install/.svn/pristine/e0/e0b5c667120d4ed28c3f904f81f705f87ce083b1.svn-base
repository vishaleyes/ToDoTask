...
<div class="gradient">
    ...
    <div id="nav">
    	<ul class="tabs page">
			<li><a href="<?php echo Yii::app()->params->base_path; ?>bridgecall" class="current">##_MOBILE_BRIDGECALL_HOME_##</a></li>
			<li><a href="<?php echo Yii::app()->params->base_path; ?>bridgecall/screenshot">##_MOBILE_BRIDGECALL_SCREENSHOT_##</a></li>
		</ul>
		<div class="clear"></div>
	</div>
    <div class="container" id="bottom_content">
    	<div class="wrapper">
        	<div class="content">
                <h1>##_MOBILE_BRIDGECALL_DESC_11_##</h1>
                <ul class="list">
                    <li>##_MOBILE_BRIDGECALL_DESC_4_##</li>
                    <li>##_MOBILE_BRIDGECALL_DESC_5_##</li>
                    <li>##_MOBILE_BRIDGECALL_DESC_6_##</li>
                </ul>
			</div>
        </div>
    </div>
