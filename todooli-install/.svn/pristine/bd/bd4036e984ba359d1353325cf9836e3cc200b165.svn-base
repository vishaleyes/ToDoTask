...
<div class="gradient">
    ...
    <div id="nav">
    	<ul class="tabs page">
   		    <li><a href="<?php echo Yii::app()->params->base_path; ?>shareudid" class="current">##_MOBILE_BRIDGECALL_HOME_##</a></li>
			<li><a href="<?php echo Yii::app()->params->base_path; ?>shareudid/screenshot">##_MOBILE_BRIDGECALL_SCREENSHOT_##</a></li>
		</ul>
		<div class="clear"></div>
	</div>
    <div class="container" id="bottom_content">
    	<div class="wrapper">
        	<div class="content">
                <h1>##_MOBILE_SHAREUDID_DESC_7_##</h1>
                <ul class="list">
                    <li>##_MOBILE_SHAREUDID_DESC_8_##</li>
                    <li>##_MOBILE_SHAREUDID_DESC_9_##</li>
                </ul>
			</div>
        </div>
    </div>
