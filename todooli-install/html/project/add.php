...
if(isset($_POST["hdnCmd"]) && $_POST["hdnCmd"] == "Update")
{
	...
	if($isValidObj['status']==0)
	{
		...
		$strSQL .=" nextMilestone = '".$_POST["nextMilestone"]."'  AND ";
		$strSQL .=" isDangerDate = '".$_POST["isDangerDate"]."'  AND ";
		$strSQL .=" newDate = '".$_POST["newDate"]." 00:00:00'  AND ";
		$strSQL .=" status = '".$_POST["status"]."'  AND ";
		$strSQL .=" issues = '".$_POST["issues"]."'  AND ";
		$strSQL .=" actionItems = '".$_POST["actionItems"]."'  ";
		$objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
...
<body>
<div class="wrapper">
    <h2>Project Management</h2><h3 align="right"><a href="index.php" class="btn">Back</a></h3>
    
    <?php if(isset($setFlash) && isset($setFlash['message'])){?>
    <div  id="flashMessage" class="<?php echo $setFlash['class'];?>">
           ...
           <!-- <div class="clear"></div>
            ...
            <div class="fieldBtn">
                ...
                { ?>
                    ...
                    <input type="button" name="Cancel" value="Cancel" onclick="window.location.href='index.php'" class="btn" />  <?php } else{ ?>
