...
<title>Todooli Inc., - BridgeCall - Join conference calls easy from iphone using this app http://todooli.com/bridgecall</title>
...
<div class="gradient">
	<div class="topbar">
    	<div class="wrapper">
        	<div class="logo">
				<a href="<?php echo Yii::app()->params->base_path; ?>site"><img src="<?php echo Yii::app()->params->base_url; ?>images/img/logo.png" alt="" border="0" /><span>&nbsp;&nbsp;##_MOBILE_LOGO_DESC_##</span></a>
            </div>
        </div>
    </div>
    ...
    <div class="wrapper">
    	<div class="banner">
        	<div class="banner-text">
            	<h2>##_MOBILE_BRIDGECALL_LOGO_##</h2>
                <p>##_MOBILE_BRIDGECALL_DESC_11_##</p>
                <div class="download"><a href="http://itunes.apple.com/us/app/bridgecall/id527833698?ls=1&mt=8"><img src="<?php echo Yii::app()->params->base_url; ?>images/img/bridgecall/iosappstorebutton.png" alt="" border="0" /><span>##_MOBILE_BRIDGECALL_DOWNLOAD_##</span></a>  </div>
            </div>
        	<div class="banner-img"><img src="<?php echo Yii::app()->params->base_url; ?>images/img/bridgecall/iphone.png" alt="" border="0" /></div>
            <div class="clear"></div>
        </div>
    </div>
    ...
    <div id="nav">
    	<ul class="tabs page">
			<li><a href="<?php echo Yii::app()->params->base_path; ?>bridgecall">##_MOBILE_BRIDGECALL_HOME_##</a></li>
			<li><a href="<?php echo Yii::app()->params->base_path; ?>bridgecall/screenshot" class="current">##_MOBILE_BRIDGECALL_SCREENSHOT_##</a></li>
		</ul>
		<div class="clear"></div>
	</div>
    <div class="container" id="bottom_content">
    	<div class="wrapper">
        	<div class="content">
                <div class="box">
                	<img src="<?php echo Yii::app()->params->base_url; ?>images/img/bridgecall/screen1.jpg" alt="" border="0" />
                    <p>##_MOBILE_BRIDGECALL_DESC_12_##</p>
                </div>
                <div class="box">
                	<img src="<?php echo Yii::app()->params->base_url; ?>images/img/bridgecall/screen2.jpg" alt="" border="0" />
                    <p>##_MOBILE_BRIDGECALL_DESC_13_##</p>
                </div>
                <div class="box">
                	<img src="<?php echo Yii::app()->params->base_url; ?>images/img/bridgecall/screen3.jpg" alt="" border="0" />
                    <p>##_MOBILE_BRIDGECALL_DESC_14_##</p>
                </div>
                <div class="clear"></div>
			</div>
        </div>
