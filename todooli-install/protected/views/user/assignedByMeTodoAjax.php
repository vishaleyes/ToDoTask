...
<div class="RightSide">	
    ...
    <script type="text/javascript">
		...
		//$j('#update-message').removeClass().html('<div class="updateLoader"><img src="'+imgPath+'/spinner-small.gif" alt="loading" border="0" /> Loading...</div>').show();
            ...
            $j.ajax({
                    type: 'POST',
                    url: '<?php echo Yii::app()->params->base_path;?>user/AssignedByMeTodoItem/moreflag/<?php echo $assignbyme['moreflag'];?>',
                    data: '<?php echo  $extraPaginationPara;?>'+'&'+$j("#assignByMeSearch").serialize(),
                    cache: false,
