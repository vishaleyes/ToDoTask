<?php
	...
	,'privacyPolicy','termsCondition','suggestedLocation','getOutLook','uploadAttach','getMyList','getMyToDoItems','getAssignedByMeItems','getOtherToDoItems','getInvites','getMyReminders','changePassword','addcomments','getcommentsByList','getMyProfile','updateProfile','addPhone','deleteList','deleteReminder','deleteItem','removeFrommyNetwork','getNetworkUserDetails','reassignTask','getItemHistory','deleteComment','itemDescription','addToDoList','addToDoItem','assignBack');
	$authorize=array();
	/*$authorize=array(
